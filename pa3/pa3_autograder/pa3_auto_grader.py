...
formats = {'first':'file', 'second':'file', 'third':'file', 'fourth':'file',
		'fifth':'file', 'sixth':'file'}# if a program has single liner input and output, we put all test cases in single file. Otherwise, we have a file for test and associated file with results
weight = {'first':1.0, 'second':1.875, 'third':0.5, 'fourth':1.5, 'fifth':2.0,
		'sixth':1.0}
