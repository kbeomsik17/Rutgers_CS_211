...
formats = {'first':'file', 'second':'file', 'third':'file', 'fourth':'line', 'fifth':'file'}

weight = {'first':0.5, 'second':0.625, 'third':0.625, 'fourth':1.0, 'fifth':1.5}

scores = {'first':0, 'second':0, 'third':0, 'fourth':0, 'fifth':0}
...
if __name__ == '__main__':
    ...
    print "Your assignment will be graded for another 25 points with test cases not given to you"
